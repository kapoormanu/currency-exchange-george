/*
 * Mockfile borrowed from https://github.com/i18next/react-i18next/blob/master/example/test-jest/src/__mocks__/react-i18next.js
 */
...
const renderNodes = (reactNodes) => {
    ...
    return Object.keys(reactNodes).map((key, i) => {
        ...
        if (hasChildren(child)) {
            const utils = renderNodes(getChildren(child));
            return cloneElement(child, { ...child.props, key: i }, utils);
        }
